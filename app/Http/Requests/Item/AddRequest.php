...
class AddRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'cuil' => 'required|integer|digits:11',
            'nac' => 'required|date',
            ...
            'presentismo' => "nullable|numeric",
            'adicional' => "nullable|numeric",
            'resolucion' => "nullable|numeric",
            'minGarantizado' => "nullable|numeric",
            'noRemunerativo' => "nullable|numeric",
            'plus' => "nullable|numeric",
            'dedicacionFuncional' => "nullable|numeric",
            'prolongacionDeJornada' => "nullable|numeric",
            'productividad' => "nullable|numeric",
